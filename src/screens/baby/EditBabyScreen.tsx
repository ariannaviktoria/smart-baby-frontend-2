...
const EditBabyScreen = () => {
  ...
  const { currentBaby, updateBaby, isLoading, error } = useBaby();
  ...
  const handleSave = async () => {
    try {
      ...
      if (currentBaby) {
        ...
        Alert.alert('Siker', 'A baba adatai sikeresen frissítve!', [
          { text: 'OK', onPress: () => navigation.goBack() }
        ]);
      }
    } catch (error: any) {
      console.error('Update baby error:', error.response?.data);
      ...
      >
        ...
        >
          <View style={styles.headerContent}>
            ...
            />
            <Text style={styles.headerTitle}>Baba szerkesztése</Text>
      ...
      <ScrollView style={styles.content}>
        ...
        >
          <View style={styles.formSection}>
            ...
            <Text style={styles.sectionDescription}>Módosítsd a baba nevét és születési idejét</Text>
          </View>
          ...
          <View style={styles.formSection}>
            ...
            <Text style={styles.sectionDescription}>Módosítsd a baba nemét</Text>
          </View>
